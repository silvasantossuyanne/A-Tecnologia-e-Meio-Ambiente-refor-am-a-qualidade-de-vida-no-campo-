...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let escalaFonte = 100; // percentual padrão
    ...
    // --- ACESSIBILIDADE: ALTERNAR MOTO CLARO / ESCURO ---
    ...
    btnIniciarVoz.addEventListener('click', () => {
        ...
        // Captura apenas o conteúdo textual relevante das seções principais
        ...
        if (textoCompleto.trim().length > 0) {
            ...
            uttr.onstart = () => {
                ...
                btnIniciarVoz.classList.add('playing');
            };
    ...
    function resetBotoesVoz() {
        ...
        btnIniciarVoz.classList.remove('playing');
    }
